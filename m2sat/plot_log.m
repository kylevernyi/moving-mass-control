...
if ~isempty(files)
    ...
    % newestFile = strcat('logs/', "long_dip_higher_adaptive_gain.csv");
...
% Plot \omega_{b2i}
figure; 
subplot(3,1,1); plot(time, data.omega_b2i_0, 'r'); legend('$\omega_{b2i,x}$'); ylabel('$\omega_{b2i}^B$ (rad/s)'); hold on;
subplot(3,1,2); plot(time, data.omega_b2i_1, 'g'); legend('$\omega_{b2i,y}$'); ylabel('$\omega_{b2i}^B$ (rad/s)');
subplot(3,1,3); plot(time, data.omega_b2i_2, 'b'); legend('$\omega_{b2i,z}$'); ylabel('$\omega_{b2i}^B$ (rad/s)');
xlabel('Time (s)');  sgtitle('$\omega_{b2i}$');

figure; 
subplot(3,1,1); plot(time, data.omega_d2i_D_0, 'r'); legend('$\omega_{d2i,x}$'); ylabel('$\omega_{d2i}^D$ (rad/s)'); hold on;
subplot(3,1,2); plot(time, data.omega_d2i_D_1, 'g'); legend('$\omega_{d2i,y}$'); ylabel('$\omega_{d2i}^D$ (rad/s)');
subplot(3,1,3); plot(time, data.omega_d2i_D_2, 'b'); legend('$\omega_{d2i,z}$'); ylabel('$\omega_{d2i}^D$ (rad/s)');
...
% Plot q_{i2b}
figure;
subplot(4,1,1); plot(time, data.q_i2b_0, 'k'); legend('$q_{i2b,0}$'); ylabel('$q_{i2b}$'); hold on;
subplot(4,1,2); plot(time, data.q_i2b_1, 'r'); legend('$q_{i2b,1}$'); ylabel('$q_{i2b}$'); 
subplot(4,1,3); plot(time, data.q_i2b_2, 'g'); legend('$q_{i2b,2}$'); ylabel('$q_{i2b}$'); 
subplot(4,1,4); plot(time, data.q_i2b_3, 'b'); legend('$q_{i2b,3}$'); ylabel('$q_{i2b}$'); 
...
figure;
subplot(3,1,1); plot(time, data.r_mass_commanded_0*1000, '--r', time, data.r_mass_0*1000, 'k'); legend('$r_{\mathrm{mass,cmd},x}$', '$r_{\mathrm{mass},x}$'); ylabel('$r$ (mm)'); hold on;
subplot(3,1,2); plot(time, data.r_mass_commanded_1*1000, '--g', time, data.r_mass_1*1000, 'k'); legend('$r_{\mathrm{mass,cmd},y}$', '$r_{\mathrm{mass},y}$'); ylabel('$r$ (mm)');
subplot(3,1,3); plot(time, data.r_mass_commanded_2*1000, '--b', time, data.r_mass_2*1000, 'k'); legend('$r_{\mathrm{mass,cmd},z}$', '$r_{\mathrm{mass},z}$'); ylabel('$r$ (mm)');
...
figure;
subplot(3,1,1); plot(time, data.u_com_0*1000, '--r', time, data.u_actual_0*1000, 'k'); legend('$u_{\mathrm{com},x}$', '$u_{\mathrm{actual},x}$'); ylabel('$u$ (mNm)'); hold on;
subplot(3,1,2); plot(time, data.u_com_1*1000, '--g', time, data.u_actual_1*1000, 'k'); legend('$u_{\mathrm{com},y}$', '$u_{\mathrm{actual},y}$'); ylabel('$u$ (mNm)');
subplot(3,1,3); plot(time, data.u_com_2*1000, '--b', time, data.u_actual_2*1000, 'k'); legend('$u_{\mathrm{com},z}$', '$u_{\mathrm{actual},z}$'); ylabel('$u$ (mNm)');
...
figure;
subplot(3,1,1); plot(time, data.theta_hat_0*1e3, 'r'); legend('$\hat{\theta}_x$'); ylabel('${\hat{\theta}}$ (mm)'); hold on;
subplot(3,1,2); plot(time, data.theta_hat_1*1e3, 'g'); legend('$\hat{\theta}_y$'); ylabel('${\hat{\theta}}$ (mm)');
subplot(3,1,3); plot(time, data.theta_hat_2*1e3, 'b'); legend('$\hat{\theta}_z$'); ylabel('${\hat{\theta}}$ (mm)');
