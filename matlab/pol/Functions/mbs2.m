function x_dot = mbs2(t,u,t_max,J,M,m,g,theta,sigma,gamma,Kp,r_max)
...
e_omega_dot = e_u_dot + e_delta_dot;

%e_omega_dot = J\(-cross(e_omega,J*e_omega) + phi*theta + u_c + delta_u);

omega_m_dot = J\(-cross(omega_m,J*omega_m));

omega_dot = e_omega_dot; %+ omega_m_dot;
...
x_dot = [omega_dot;q_dot;theta_tilde_dot;beta_tilde_dot;
    omega_m_dot;e_delta_dot];
