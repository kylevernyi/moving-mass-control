function [Q,T] = DQrotationalmatrixFromRandV(r_ECIF,v_ECIF)
...
Q = [
    1,zeros(1,3),0,zeros(1,3);
    zeros(3,1),T,zeros(3,1),zeros(3,3);
    0,zeros(1,3),1,zeros(1,3);
    zeros(3,1),zeros(3,3),zeros(3,1),T
    ]; 
